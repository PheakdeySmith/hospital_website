    ...
    <tbody>
        @forelse($doctors as $doctor)
            <tr>
                ...
                <td>
                    <a href="{{ route('manager.doctors.edit', $doctor->id) }}" class="btn btn-warning btn-sm">Edit</a>
                    <form action="{{ route('manager.doctors.destroy', $doctor->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
