...
class AdminTreatmentController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.admin.treatments.index', $data);
    }

    public function create()
    {
        return view('dashboard.admin.treatments.create');
    }
    ...
    {
        return view('dashboard.admin.treatments.edit', compact('treatment'));
    }
