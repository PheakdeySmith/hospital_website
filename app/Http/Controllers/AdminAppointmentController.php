...
class AdminAppointmentController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.admin.appointments.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.admin.appointments.create', $data);
    }

    public function store(Request $request)
    {
        $redirectRoute = $request->input('form_source') === 'front' ? 'front.index' : 'admin.appointments.index';
        try {
    ...
    public function edit(Appointment $appointment)
    {
        ...
        return view('dashboard.admin.appointments.edit', $data);
    }
    ...
    public function update(Request $request, Appointment $appointment)
    {
        try {
            ...
            return redirect()->route('admin.appointments.index')->with('error', 'Error: ' . $e->getMessage());
        }
    }
