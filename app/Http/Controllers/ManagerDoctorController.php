...
class ManagerDoctorController extends Controller
{
    public function index()
    {
        $data['doctors'] = Doctor::all();
        return view('dashboard.manager.doctors.index', $data);
    }

    public function create()
    {
        return view('dashboard.manager.doctors.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('manager.doctors.index')->with('success', 'Doctor created successfully.');
        } catch (\Exception $e) {
    ...
    {
        return view('dashboard.manager.doctors.edit', compact('doctor'));
    }
